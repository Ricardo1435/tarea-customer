...
<div class="container md mt-2 col-lg-5">
    <div class="card border-info">
        <div class="card-header bg-info text-white">
            <center><h2 class="mt-2 mb-2"> EDITAR CATEGORÍA &nbsp;<i class="fas fa-pen-alt"></i></h2> </center>
        </div>
        <div class="card-body">
            <!-- Formulario -->
            <form action="{{route('categoryUpdate', $category->id)}}" method="POST">
                ...
                <div>
                    ...
                    <input type="text" value="{{$category->description}}" id="description" class="form-control" autocomplete="off" name="description" placeholder="" maxlength="45" required>
                </div>
